...
c.push(new Paragraph({ children: [new TextRun({ text: '슬라이드 12장  ·  실측 9:16  ·  10:00까지 여유 43초', font: FONT, size: 22, bold: true, color: BLUE })], alignment: AlignmentType.CENTER, spacing: { after: 240 } }));
