...
function 사장님설문폼만들기(ss) {
  ...
  form.setDescription(
    [
      ...
      '불쑥 연락드려 죄송합니다.',
      '',
      '강남구에서 예약을 받아 가게를 꾸려 가시는 모습을 보면서,',
      '갑작스러운 노쇼나 당일 취소, 그리고 손님이 뜸한 낮 시간처럼',
      '어쩔 수 없이 흘려보내게 되는 시간이 늘 아깝게 느껴졌습니다.',
      '',
      '그 시간을, 지금 근처에서 바로 갈 수 있는 손님과 연결해 드리는',
      '작은 앱을 만들어 보려고 준비하고 있습니다.',
      '',
      '· 비어버린 자리를 올려 두시면, 30분 안에 도착할 수 있는 손님에게만 보입니다',
      '· 정가보다 낮은 가격으로, 그 자리에서 바로 예약과 결제가 이뤄집니다',
      '· 리뷰가 좋은 우수 사업자께는 앱이 쿠폰을 지원해 드릴 계획입니다',
      '',
      '다만 제 생각만으로 시작할 일은 아니라고 생각했습니다.',
      '이것이 정말 필요한 것인지, 현장에 계신 원장님께 먼저 여쭙는 것이',
      '순서라고 생각해서 이렇게 여쭙습니다.',
      '',
      '문항은 17개이고 대부분 고르기만 하시면 되어 1~2분이면 충분합니다.',
      '답변은 익명으로 처리되며 통계 목적 외에는 사용하지 않습니다. 로그인도 필요 없습니다.',
      '',
      '바쁘신 중에 귀한 시간 내어 주셔서 진심으로 감사드립니다.',
